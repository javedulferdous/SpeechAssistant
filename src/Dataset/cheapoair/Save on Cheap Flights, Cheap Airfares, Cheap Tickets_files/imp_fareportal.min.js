    ...
    return IMP_HL = {
				...
				function() {
					try {
						if (appendReferenceLog()) {
							...
							IMP.appendSiteProp("impversion","post_z55");
							try {
		...
		trackReferenceDelay: function () {
					try {
						if (appendReferenceLog()) {
							...
							IMP.appendSiteProp("fpuid",fpuid);
							IMP.appendSiteProp("impreference","1");
							IMP.appendSiteProp("impversion","delay_z55");
							try {
								IMP.appendSiteProp("impnavigator",navigator.userAgent.replace(/[:"]/g, ""));
							}
							catch (e) {
		...
		addAttachmentsMob: function () {
			try {
				...
				var ni_seat_val = "0";
				var ni_insurance_set = false;
				var ni_support_set = false;
				var ni_flexticket_set = false;
				var ni_revplus_set = false;
				var ni_assist_set = false;
				...
				for (ni_attachment_index=0;ni_attachment_index<15;ni_attachment_index++) {
					if (source_attachment.length > ni_attachment_index) {
						source_attachment_split = source_attachment[ni_attachment_index].split('\t');
						if (source_attachment_split.length > 1) {
							...
							var ni_attachment_rowlen = source_attachment_split.length;
							ni_attachment.attachments[ni_attachment_index].value = "";
							if (ni_attachment_rowlen > 1) {
								ni_attachment.attachments[ni_attachment_index].value = source_attachment_split[ni_attachment_rowlen - 1];
							}
							if (ni_attachment.attachments[ni_attachment_index].name.toLowerCase().indexOf('protect') > -1) {
								if (ni_attachment.attachments[ni_attachment_index].value.toLowerCase().indexOf('add') < 0) {
									ni_insurance_set = true;
								}
							}
							...
							if (ni_attachment.attachments[ni_attachment_index].name.toLowerCase().indexOf('support') > -1) {
								ni_support_set = true;
							}
							if (ni_attachment.attachments[ni_attachment_index].name.toLowerCase().indexOf('drop') > -1) {
								ni_revplus_set = true;
							}
							if (ni_attachment.attachments[ni_attachment_index].name.toLowerCase().indexOf('flexible') > -1) {
								ni_flexticket_set = true;
							}
							if (ni_attachment.attachments[ni_attachment_index].name.toLowerCase().indexOf('assist') > -1) {
								ni_assist_set = true;
							}
						} 
				...
				if (ni_insurance_set) {
					...
					IMP.appendSiteProp('ni_IsInsuranceAdded_final', ni_IsInsuranceAdded);
				}
				if (ni_seat_add == true) {
					...
					IMP.appendSiteProp("ni_SelectSeats_final", ni_SelectSeats);
					IMP.appendSiteProp("ni_SelectSeats_total", "0");
				}
				if (ni_support_set) {
					IMP.appendSiteProp('ni_supportPkgMVP', 2);
					IMP.appendSiteProp('ni_supportPkgMVP_final', 2);
				} else {
					IMP.appendSiteProp('ni_supportPkgMVP', ni_supportPkgMVP);
					IMP.appendSiteProp('ni_supportPkgMVP_final', ni_supportPkgMVP);
				}
				if (ni_flexticket_set) {
					IMP.appendSiteProp('ni_flexibleTicket', 2);
					IMP.appendSiteProp('ni_flexibleTicket_final', 2);
				} else {
					IMP.appendSiteProp('ni_flexibleTicket', ni_flexibleTicket);
					IMP.appendSiteProp('ni_flexibleTicket_final', ni_flexibleTicket);
				}
				if (ni_revplus_set) {
					IMP.appendSiteProp("ni_revPlusTrigger", 2);
					IMP.appendSiteProp("ni_revPlusTrigger_final", 2);
				} else {
					IMP.appendSiteProp("ni_revPlusTrigger", ni_revPlusTrigger);
					IMP.appendSiteProp("ni_revPlusTrigger_final", ni_revPlusTrigger);
				}
				if (ni_assist_set) {
					IMP.appendSiteProp("ni_travelAssTrigger", 2);
					IMP.appendSiteProp("ni_travelAssTrigger_final", 2);
				} else {
					IMP.appendSiteProp("ni_travelAssTrigger", ni_travelAssTrigger);
					IMP.appendSiteProp("ni_travelAssTrigger_final", ni_travelAssTrigger);
				}
        ...
        appendLocalSitePropPostReply: function (logactive, eventlogactive, detaillogactive) {
			...
			if (logactive) {
				...
				if ( (document.location.href.toLowerCase().indexOf("m.cheapoair.com/air/review") > -1) ||
					(document.location.href.toLowerCase().indexOf("m.onetravel.com/air/review") > -1) ) {
					setTimeout(function() {
						try {
				...
				if ( (document.location.href.toLowerCase().indexOf("m.cheapoair.com/air/book") > -1) ||
					(document.location.href.toLowerCase().indexOf("m.onetravel.com/air/book") > -1) ) {
					setTimeout(function() {
						IMP_HL.addAttachmentsMob();
					}, 2000);
				}
			...
			if (detaillogactive) {
				...
				if ( (document.location.href.toLowerCase().indexOf("www.cheapoair.com/air/listing") > -1) ||
					(document.location.href.toLowerCase().indexOf("www.onetravel.com/air/listing") > -1) )
				{
					setTimeout(function() {
						try {
							var anyprc = false;
				...
				if ( (document.location.href.toLowerCase().indexOf("www.cheapoair.com/air/payment") > -1) ||
					(document.location.href.toLowerCase().indexOf("www.onetravel.com/air/payment") > -1) ) {
					setTimeout(function() {
						try {
							ni_IsInsuranceAdded = 0;
							...
							IMP.appendSiteProp("ni_upgradeBtn",ni_upgradeBtn);
							IMP.appendSiteProp("ni_upgradeBtn_final",ni_upgradeBtn);
