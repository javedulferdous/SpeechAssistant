    ...
    app = {
        ...
        tplVars: {
            images: {
                ...
                paths: {
                    body: ['cdn', 'medals/summary/' + 23773 + '_medal_summary.gif'],
            ...
            registeredText: '',
            participatingText: '',
            target: 'http://www.bizrate.com/ratings_guide/merchant_detail__mid--' + 23773 + '.html?rf=sur',
            certified: true,
			MID: '23773',		
	    ...
	    setShowMouseOver: function () {
	    	...
	    	safeMerchantName = this.escapeString("CarParts.com");
