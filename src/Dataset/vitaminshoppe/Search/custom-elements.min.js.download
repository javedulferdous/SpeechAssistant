...
*/
      ...
      if (f.nodeType === Node.ELEMENT_NODE) {
        ...
        if ("link" === e && "import" === d.getAttribute("rel")) {
          ...
          if (f instanceof Node && !c.has(f))
            for (c.add(f), f = f.firstChild; f; f = f.nextSibling) L(f, b, c);
          f = K(a, d);
          continue;
        } else if ("template" === e) {
          f = K(a, d);
        ...
        if ((d = d.__CE_shadowRoot))
          for (d = d.firstChild; d; d = d.nextSibling) L(d, b, c);
      }
  ...
  ta.prototype.f = function(a) {
    ...
    for (b = 0; b < a.length; b++)
      for (var c = a[b].addedNodes, f = 0; f < c.length; f++) N(this.c, c[f]);
  };
  function va() {
    var a = this;
  ...
  function za(a, b, c) {
    ...
    try {
      ...
      var l =
        ((f = d("attributeChangedCallback")) && c.observedAttributes) || [];
    } catch (m) {
      throw m;
    } finally {
      a.i = !1;
