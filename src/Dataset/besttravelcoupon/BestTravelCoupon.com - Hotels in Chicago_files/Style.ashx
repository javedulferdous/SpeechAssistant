...
.hc_f_t_date5 img {
  ...
  *float: left;
  ...
  vertical-align: middle;
  cursor: pointer;
  hack: 1 ; background: #0084C1 url(https://cdn.datahc.com/Images/hc_icon_calendar_inverse.gif?1.0.2020.303002-C38138af86f3b129a8c0e0912550347e20ab38e38) no-repeat 0 0;
  overflow: hidden;
}
.hc_f_t_date5 img {
  position: absolute;
...
.hc_f_btn_v1 {
  ...
  hack: 1 ; background-image: -moz-linear-gradient(center top , rgba(255,255,255,0.4) -10%, #EE7700 50%, #EE7700 50%, #EE7700 100%);
  hack: 1 ; background-image: -ms-linear-gradient(rgba(255,255,255,0.4), #EE7700);
  hack: 1 ; background-image: -webkit-gradient(linear, left top, left bottom, color-stop(-10%,rgba(255,255,255,0.4)), color-stop(100%, #EE7700));
  hack: 1 ; background-image: -webkit-linear-gradient(rgba(255,255,255,0.4), #EE7700);
  hack: 1 ; background-image: -o-linear-gradient(rgba(255,255,255,0.4), #EE7700);
  hack: 1 ; background-image: linear-gradient(top, rgba(255,255,255,0.4) -10%, #EE7700 100%);
...
.hc_f_btn_v1:hover {
  color: #FFFFFF !important;
  background-color: #669900;
  hack: 1 ; background-image: -moz-linear-gradient(center top , rgba(255,255,255,0.4) -10%, #669900 50%, #669900 50%, #669900 100%);
  hack: 1 ; background-image: -ms-linear-gradient(rgba(255,255,255,0.4), #669900);
  hack: 1 ; background-image: -webkit-gradient(linear, left top, left bottom, color-stop(-10%,rgba(255,255,255,0.4)), color-stop(100%, #669900));
  hack: 1 ; background-image: -webkit-linear-gradient(rgba(255,255,255,0.4), #669900);
  hack: 1 ; background-image: -o-linear-gradient(rgba(255,255,255,0.4), #669900);
  hack: 1 ; background-image: linear-gradient(top, rgba(255,255,255,0.4) -10%, #669900 100%);
...
.hc_f_btn_v4 {
  ...
  color: #FFFFFF !important;
  background-color: #0084C1;
  hack: 1 ; background-image: -moz-linear-gradient(center top , rgba(255,255,255,0.4) -10%, #0084C1 50%, #0084C1 50%, #0084C1 100%);
  hack: 1 ; background-image: -ms-linear-gradient(rgba(255,255,255,0.4), #0084C1);
  hack: 1 ; background-image: -webkit-gradient(linear, left top, left bottom, color-stop(-10%,rgba(255,255,255,0.4)), color-stop(100%, #0084C1));
  hack: 1 ; background-image: -webkit-linear-gradient(rgba(255,255,255,0.4), #0084C1);
  hack: 1 ; background-image: -o-linear-gradient(rgba(255,255,255,0.4), #0084C1);
  hack: 1 ; background-image: linear-gradient(top, rgba(255,255,255,0.4) -10%, #0084C1 100%);
...
.hc_f_btn_v4:hover {
  ...
  hack: 1 ; background-image: -moz-linear-gradient(center top , rgba(255,255,255,0.4) -10%, #00AEFF 50%, #00AEFF 50%, #00AEFF 100%);
  hack: 1 ; background-image: -ms-linear-gradient(rgba(255,255,255,0.4), #00AEFF);
  hack: 1 ; background-image: -webkit-gradient(linear, left top, left bottom, color-stop(-10%,rgba(255,255,255,0.4)), color-stop(100%, #00AEFF));
  hack: 1 ; background-image: -webkit-linear-gradient(rgba(255,255,255,0.4), #00AEFF);
  hack: 1 ; background-image: -o-linear-gradient(rgba(255,255,255,0.4), #00AEFF);
  hack: 1 ; background-image: linear-gradient(top, rgba(255,255,255,0.4) -10%, #00AEFF 100%);
...
.hc_f_viewDealButton .hc_f_btn_v8:hover {
  ...
  hack: 1 ; background-image: -moz-linear-gradient(center top , rgba(255,255,255,0.4) -10%, #8FC734 50%, #8FC734 50%, #8FC734 100%);
  hack: 1 ; background-image: -ms-linear-gradient(rgba(255,255,255,0.4), #8FC734);
  hack: 1 ; background-image: -webkit-gradient(linear, left top, left bottom, color-stop(-10%,rgba(255,255,255,0.4)), color-stop(100%, #8FC734));
  hack: 1 ; background-image: -webkit-linear-gradient(rgba(255,255,255,0.4), #8FC734);
  hack: 1 ; background-image: -o-linear-gradient(rgba(255,255,255,0.4), #8FC734);
  hack: 1 ; background-image: linear-gradient(top, rgba(255,255,255,0.4) -10%, #8FC734 100%);
  border-color: #8FC734;
}
/* -------- Button v9 & v10 -------- */
/* button type: search */
